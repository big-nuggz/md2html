...
# Full HTML template with navigation bar and styling links
...
<body>
    <nav class="top-nav">
        ...
        <a href="{index_path}" class="nav-home">&#8592; Home</a>
...
{body}
    ...
    <footer>
        <p>Generated by dividendos &mdash; <a href="{index_path}">Back to index</a></p>
    </footer>
